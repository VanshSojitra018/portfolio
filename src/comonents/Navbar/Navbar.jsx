    ...
    >
      <div className="text-white py-5 flex justify-between items-center">
        ...
        <div className="text-lg font-semibold cursor-pointer">
          ...
          <span className="text-[#8245ec]">/</span>
          <span className="text-white">Sojitra</span>
          <span className="text-[#8245ec]">&gt;</span>
        </div>
        {/* Logo end */}
      ...
      {isOpen && (
        <div className="absolute top-16 left-1/2 transform -translate-x-1/2 w-4/5 bg-[#050414] bg-opacity-50 backdrop-blur-lg backdrop-filter z-50 rounded-lg shadow-lg">
