...
const Work = () => {
  ...
  const handelCloseModal = (project) => {
  ...
  return (
    ...
    >
      ...
      {/* Project Grid 2 box end */}

      {/* Modal Container start */}

      {selectedProject && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90 p-4">
          <div className="bg-gray-900 rounded-xl shadow-xl lg:w-full w-[90%] max-w-3xl overflow-hidden relative">
